...
export const config = {
  ...
  deploy: {
    // The deploy target's public hostname only offers GSSAPI auth for root;
    // from the control host this runs on it's reachable over the internal
    // LAN, where key-based SSH works.
